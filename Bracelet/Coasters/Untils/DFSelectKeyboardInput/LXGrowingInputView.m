...
- (void) setupViewConstraints {
    ...
    bgView.backgroundColor = [UIColor colorWithRed:241/255.0 green:241/255.0 blue:241/255.0 alpha:1];\
...
- (UIButton *)leftButton
{
    if (!_leftButton)
    {
        ...
        UIImage * norImage = [UIImage imageNamed:@"keyboard_btn_default@2x.png"];
        UIImage * hlImage = [UIImage imageNamed:@"keyboard_btn_emoji@2x.png"];
...
- (UIButton *)rightButton
{
    if (!_rightButton)
    {
        ...
        [_rightButton setTitle:kString(@"发送") forState:UIControlStateNormal];
...
- (void) textViewDidChange:(UITextView *)textView {
    ...
    if (number > _length) {
        textView.text = [textView.text substringToIndex:_length];
        number = _length;
    }
