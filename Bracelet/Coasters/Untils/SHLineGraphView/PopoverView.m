...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withText:(NSString *)text
{
    ...
    CGSize textSize;
    CGSize size = CGSizeMake(screenSize.width - kHorizontalMargin*4.f, 1000.f);
    NSMutableParagraphStyle *style = [[NSMutableParagraphStyle alloc] init];
    [style setLineBreakMode:UILineBreakModeWordWrap];
...
//    CGSize titleSize = [title sizeWithFont:kTitleFont];
    NSDictionary* stringAttrs = @{ NSFontAttributeName : kTitleFont };
    CGSize titleSize = [title sizeWithAttributes:stringAttrs];
...
//        CGSize textSize = [string sizeWithFont:font];
        ...
        CGSize textSize = [string sizeWithAttributes:stringAttrs];
