...
-(void)_setUp
{
    CGFloat tagHeight = ([[[UIDevice currentDevice] systemVersion] doubleValue] >= 7.0 ? 64:44);
    CGFloat heigthTag = [[UIScreen mainScreen] bounds].size.height * self.radioInScreenHeight + tagHeight;  // 0.4
    self.headerHeight = heigthTag;
    self.segmentHeight = 0;
    self.segmentToInset = heigthTag;
